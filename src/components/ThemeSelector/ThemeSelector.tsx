...
import { BALL_SIZE, BUTTON_WIDTH, BUTTON_HEIGHT, pixelRatio } from './constants';
  ...
  const renderBallCircles = () => {
    return (
      <BallCircleWrapper animate={isPrimaryTheme}>
        <BallCircle $size={pixelRatio * 8} $posX={pixelRatio * 4} $posY={pixelRatio * 18} />
        <BallCircle $size={pixelRatio * 5} $posX={pixelRatio * 12} $posY={pixelRatio * 13} />
        <BallCircle $size={pixelRatio * 3} $posX={pixelRatio * 5} $posY={pixelRatio * 12} />
        <BallCircle $size={pixelRatio * 4} $posX={pixelRatio * 12} $posY={pixelRatio * 4} />
      </BallCircleWrapper>
    );
  };
  ...
  const renderClouds = () => {
    return (
      <CloudsWrapper animate={isPrimaryTheme}>
        <Cloud posX={pixelRatio * 10} posY={pixelRatio * 15} size={pixelRatio * 25} />
        <Cloud posX={pixelRatio * 8} posY={pixelRatio * 8} size={pixelRatio * 13} />
      </CloudsWrapper>
    );
  };
  ...
  const renderStars = () => {
    return (
      <StarsWrapper animate={isSecondaryTheme}>
        <Star size={pixelRatio * 2} posX={pixelRatio * 31} posY={pixelRatio * 16} />
        <Star size={pixelRatio * 3} posX={pixelRatio * 36} posY={pixelRatio * 5} />
        <Star size={pixelRatio * 1} posX={pixelRatio * 51} posY={pixelRatio * 16} />
        <Star size={pixelRatio * 2} posX={pixelRatio * 43} posY={pixelRatio * 23} />
        <Star size={pixelRatio * 2} posX={pixelRatio * 50} posY={pixelRatio * 5} />
        <Star size={pixelRatio * 1} posX={pixelRatio * 41} posY={pixelRatio * 15} />
      </StarsWrapper>
    );
  };
    ...
    <>
      <Wrapper>
        <ToggleSwitch
          ...
          onClick={toggleTheme}
        >
          <Ball variants={BALL_VARIANTS} $size={BALL_SIZE} animate={isPrimaryTheme}>
            {renderBallCircles()}
          </Ball>
          <Glow $size={BALL_SIZE} variants={GLOW_VARIANTS} animate={isPrimaryTheme} />
          <BackgroundWrapper>
